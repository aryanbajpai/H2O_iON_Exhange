    ...
    >
      {selectedIndex && (
        <div>
          ...
          <Paragraph para="Disinfection: Disinfection is the most important single factor in maintaining a safe pool. Chlorine is the most widely applied disinfecting agent for the swimming pool water. Its not only destroys harmful organisms such as bacteria, algae, fungi, viruses but it also destroy impurities that are not removed by filtration." addClass={"my-5"}/>
        </div>
      )}
    </GridBox>
  );
